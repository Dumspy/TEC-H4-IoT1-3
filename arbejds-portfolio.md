...
### PoC
Initiale Proof of concept ekistere stadige [her](https://github.com/Dumspy/TEC-H4-IoT1-3/tree/poc), denne poc er blevet brugt som base til det færdige project.

### Debounce
**Hvordan løser vi dette?**
    - debounce burde ikke opstå/være et problem, da vi kun håndtere det enklte tryk som forårsaget wake up
...
- Måske Wifi i sync step istedet for hvert klik, gem til file i mellem tiden.
    - Wifi er flytted til kun at håndteres i "sync" steppet til både at sync fra vores locale log fil til mqtt & sync ntp
